...
export default {
  ...
  initClickEvents(site) {
    document.querySelector("#email").addEventListener("click", () => {
      window.open("mailto:nesrinesghaier10@gmail.com");
    });

    document.querySelector("#medium").addEventListener("click", () => {
      window.open("https://medium.com/@nesrinesghaier10");
    });

    document.querySelector("#linkedin").addEventListener("click", () => {
      window.open("https://www.linkedin.com/in/sghaiernesrine", "_blank");
    });
    ...
    document.querySelector("#instagram").addEventListener("click", () => {
      window.open("https://www.instagram.com/sghaier_nesrine", "_blank");
    });

    document.querySelector("#twitter").addEventListener("click", () => {
      window.open("https://twitter.com/nesrine_sghaier", "_blank");
    });
